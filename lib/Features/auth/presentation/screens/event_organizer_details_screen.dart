// Presentation Layer - Event Organizer Details Screen
...
class EventOrganizerDetailsScreen extends StatefulWidget {
  ...
  const EventOrganizerDetailsScreen({
    super.key,
    required this.name,
    required this.email,
  ...
  @override
  State<EventOrganizerDetailsScreen> createState() =>
...
class _EventOrganizerDetailsScreenState
  ...
  Future<void> _handleCompleteRegistration() async {
    ...
    try {
      // Complete signup with event organizer data
      await _authService.completeSignUp(
        ...
        organizationDescription: _descriptionController.text,
        organizationWebsite:
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Description
                Text(
                  'Tell us about your organization to help students discover your events.',
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                    hintText: 'Organization Type (e.g., Club, Guild, Society)',
                    hintStyle: TextStyle(color: Colors.grey[400]),
                    prefixIcon: Icon(
