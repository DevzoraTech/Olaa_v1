-- ============================================================================
-- PRODUCTION-READY CHAT SETUP FOR PULSE CAMPUS (FIXED PERMISSIONS)
-- ============================================================================
...
-- ============================================================================
-- 9. SETUP STORAGE BUCKET (WITH PERMISSION HANDLING)
-- ============================================================================

-- Create chat-files storage bucket (only if it doesn't exist)
...
-- ============================================================================
-- 10. ENABLE REALTIME (WITH PERMISSION HANDLING)
-- ============================================================================

-- Enable realtime for messages table (only if we have permission)
DO $$
BEGIN
  ...
  EXCEPTION WHEN insufficient_privilege THEN
    RAISE NOTICE 'Insufficient privileges to add messages to realtime publication';
  END;
  
  BEGIN
    ALTER PUBLICATION supabase_realtime ADD TABLE chats;
  EXCEPTION WHEN insufficient_privilege THEN
    RAISE NOTICE 'Insufficient privileges to add chats to realtime publication';
  END;
END $$;
...
-- ✅ Secure RLS policies
-- ✅ Optimized indexes
-- ✅ Realtime subscriptions (if permissions allow)
